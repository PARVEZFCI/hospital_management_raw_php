...
<style>
 ...
 #addspecialization ,#adddoctor,#managedoctor{
     background:#ffff;
     padding:20px;
 }
...
<?php } }  ?>
      ...
      <div class="col col-lg-12" id="adddoctor">
         ...
         <form action="addspecializationsql.php" method="post">
            <input type="text" name="doctors" id="" placeholder="add Doctor " class="form-control"><br>
...
<tr><td></td> <td> Dr. <?php  echo $row['doctors'];  ?></td><td><?php  echo $row['cdate'];  ?></td> <td><a href="deletedoctor.php?x=<?php echo $row['id'];  ?>"> <span class="fa fa-trash"></span></a> </td></tr>
